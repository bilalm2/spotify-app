...
const trackData = await fetchTopTracks(sessionStorage.getItem("access_token"));
populateProfile(profile);
populateArtists(artistData);
populateTracks(trackData);
